\# Case Study: Jak mi kód vydělal na hardware
...
\## 🛠️ Jak to celé začalo (Setup)



Na začátku stála jednoduchá potřeba: levně sehnat materiál na stavbu off-grid dílny. Místo ručního prohledávání inzerátů vznikl automatický „slídil“ (scraper), který hlídal \[Bazoš.cz](http://xn--Bazo-j6a.cz).
