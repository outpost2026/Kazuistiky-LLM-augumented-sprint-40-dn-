...
curl -s -X POST “\[https://api.example.com/endpoint](https://api.example.com/endpoint)” | python3 -m json.tool | head -40
...
delta\_t = abs(bms\_temp - chmu\_temp)

TOLERANCE = 0.75  # stupně Celsia



if delta\_t > TOLERANCE:

&#x20;   flag\_for\_review(timestamp, delta\_t, "temp\_crossval\_fail")
